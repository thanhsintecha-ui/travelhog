...
// Gallery data
const galleryImagesRow1: GalleryImage[] = [
  {
    id: 1,
    src: 'https://cms.honghaotravel.com/wp-content/uploads/2024/05/Rectangle-34624952.webp',
    alt: 'demo',
  },
  {
    id: 2,
    src: 'https://cms.honghaotravel.com/wp-content/uploads/2024/05/bg.jpg',
    alt: 'demo',
  },
  {
    id: 3,
    src: 'https://cms.honghaotravel.com/wp-content/uploads/2024/05/65b3a47362dea5277474d77c_African-leopard-female-pose-in-beautiful-evening-light.-1070008700_4265x2843.webp-1-1.jpg',
    alt: 'demo',
  },
  {
    id: 4,
    src: 'https://cms.honghaotravel.com/wp-content/uploads/WhatsApp-Image-2024-07-22-at-11.25.35_895d3447.jpg',
    alt: 'demo',
  },
  {
    id: 5,
    src: 'https://cms.honghaotravel.com/wp-content/uploads/WhatsApp-Image-2024-07-10-at-13.20.54_de22707b.jpg',
    alt: 'demo',
  },
];

const galleryImagesRow2: GalleryImage[] = [
  {
    id: 6,
    src: 'https://cms.honghaotravel.com/wp-content/uploads/Nature-scaled-1-13.jpg',
    alt: 'demo',
  },
  {
    id: 7,
    src: 'https://cms.honghaotravel.com/wp-content/uploads/2024/05/nature.jpg',
    alt: 'demo',
  },
  {
    id: 8,
    src: 'https://cms.honghaotravel.com/wp-content/uploads/2024/05/Frame-1410139156-1-1.jpg',
    alt: 'demo',
  },
  {
    id: 9,
    src: 'https://cms.honghaotravel.com/wp-content/uploads/WhatsApp-Image-2024-07-22-at-11.25.34_7b402ab5.jpg',
    alt: 'demo',
  },
  {
    id: 10,
  ...
  {
    id: 11,
    src: 'https://cms.honghaotravel.com/wp-content/uploads/WhatsApp-Image-2024-07-22-at-10.57.04_868b1ad5.jpg',
    alt: 'demo',
  },
  {
    id: 12,
    src: 'https://cms.honghaotravel.com/wp-content/uploads/WhatsApp-Image-2024-07-21-at-11.04.48_1ac3d7ff.jpg',
    alt: 'demo',
  },
];

// Reusable Compass Icon
const CompassIcon: React.FC<{ className?: string; fill?: string }> = ({ className, fill = '#E64828' }) => (
  <svg
...
const SpinningCompass: React.FC<{ inverted?: boolean }> = ({ inverted = false }) => (
  <div className="size-[6.5625rem] relative">
    <Image
      ...
      decoding="async"
      data-nimg="1"
      className={`animate-spin object-cover size-full ${inverted ? 'brightness-100 invert' : ''}`}
      src="/text-circle-box-map.svg"
    />
    <CompassIcon 
      className="size-[2.375rem] absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2"
      fill={inverted ? '#FFFFFF80' : '#E64828'}
    />
  </div>
);
  ...
  <div className="mb-[3rem] flex justify-between items-center w-[calc(100%-16.665rem)] ml-auto">
    ...
    <div className="w-[42.6875rem] h-[4.9375rem] bg-[linear-gradient(90deg,rgba(255,255,255,0.00)_-48.55%,rgba(12,140,30,0.14)_100%)] flex items-center">
      <p className="text-[0.875rem] font-normal leading-[1.2] tracking-[0.00875rem] text-[#262626] ml-[2.13rem]">
        Don't hesitate to pick up your backpack and go.  When you reach your destination and <br />
        see all the beautiful things in sight, you will know that your efforts were worth it...
      </p>
    </div>
  </div>
);
...
const GalleryItem: React.FC<{ image: GalleryImage }> = ({ image }) => (
  <div className="item_slide w-[33.33rem] flex-shrink-0 h-[21.125rem] relative group">
    ...
    <div className="size-[6.5625rem] absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 z-10 opacity-0 lg:group-hover:opacity-100 transition-all duration-200">
      <SpinningCompass inverted />
    </div>
  </div>
);

// Discovery Button Component
const DiscoveryButton: React.FC = () => (
...
const GallerySlider: React.FC = () => (
  <div className="relative w-full h-fit">
    ...
    <div className="absolute top-0 left-0 h-[21.125rem] w-[21.5rem] flex z-[99]">
      ...
      <div className="h-full w-[6.5rem] bg-[linear-gradient(270deg,rgba(255,255,255,0.00)_36.51%,#FFF_92.5%)]" />
    </div>
    ...
    <div className="relative w-full overflow-hidden h-[43rem] container_slide">
      <div
        ...
        style={{
          ...
          rotate: 'none',
          scale: 'none',
          transform: 'translate3d(-1893px, 0px, 0px)',
          touchAction: 'pan-y',
          cursor: 'grab',
          userSelect: 'none',
        }}
      >
        ...
        {/* Row 2 */}
        <div id="slide_item_2" className="flex space-x-[0.75rem]">
...
export default function OurGallery() {
  return (
    <section className="w-full h-fit pb-[0.8rem] xlg:hidden z-20 relative">
      <GalleryHeader />
      <GallerySlider />
    </section>
  );
