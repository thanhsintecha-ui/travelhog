...
// Placeholder data for gallery images - you'll replace these with actual images
const galleryImagesRow1: GalleryImage[] = [
  {
    id: 1,
    src: '/Rectangle-34624952.webp',
    alt: 'demo',
  },
  {
    id: 2,
  ...
  {
    id: 3,
    src: '/65b3a47362dea5277474d77c_African-leopard-female-pose-in-beautiful-evening-light.-1070008700_4265x2843.webp-1-1.jpg',
    alt: 'demo',
  },
  {
    id: 4,
    src: '/WhatsApp-Image-2024-07-22-at-11.25.35_895d3447.jpg',
    alt: 'demo',
  },
  {
    id: 5,
    src: '/WhatsApp-Image-2024-07-10-at-13.20.54_de22707b.jpg',
    alt: 'demo',
  },
];
...
const galleryImagesRow2: GalleryImage[] = [
  ...
  {
    id: 8,
    src: '/Frame-1410139156-1-1.jpg',
    alt: 'demo',
  },
  {
    id: 9,
    src: '/WhatsApp-Image-2024-07-22-at-11.25.34_7b402ab5.jpg',
    alt: 'demo',
  },
  {
    id: 10,
  ...
  {
    id: 11,
    src: '/WhatsApp-Image-2024-07-22-at-10.57.04_868b1ad5.jpg',
    alt: 'demo',
  },
  {
    id: 12,
    src: '/WhatsApp-Image-2024-07-21-at-11.04.48_1ac3d7ff.jpg',
    alt: 'demo',
  },
];
...
const GalleryItem = ({ image }: { image: GalleryImage }) => (
  <div className="item_slide w-[33.33rem] flex-shrink-0 h-[21.125rem] relative group">
    ...
    <div className="size-[6.5625rem] absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 z-10 opacity-0 lg:group-hover:opacity-100 transition-all duration-200">
      ...
      />
      <MapIcon className="size-[2.375rem] absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2" />
    </div>
  </div>
);
      ...
      <div className="mb-[3rem] flex justify-between items-center w-[calc(100%-16.665rem)] ml-auto">
        ...
        <div className="size-[6.5625rem] relative">
          <Image
            ...
            width={100}
            height={100}
            className="animate-spin object-cover size-full"
            src="/text-circle-box-map.svg"
          />
          <MapIcon className="size-[2.375rem] absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2" />
        </div>
        <div className="w-[42.6875rem] h-[4.9375rem] bg-[linear-gradient(90deg,rgba(255,255,255,0.00)_-48.55%,rgba(12,140,30,0.14)_100%)] flex items-center">
          <p className="text-[0.875rem] font-normal leading-[1.2] tracking-[0.00875rem] text-[#262626] ml-[2.13rem]">
            Don&apos;t hesitate to pick up your backpack and go. When you reach your destination and{' '}
            <br /> see all the beautiful things in sight, you will know that your efforts were worth
            it...
          </p>
        </div>
      </div>
